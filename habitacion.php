...
if(isset($_POST["consultar"])){ 
    ...
    $salida= $_POST["salida"];
    $url="http://localhost:8888/E2/servicios/consultarDisponibilidad.php?entrada=$entrada&salida=$salida";
    ...
    <div class="habitaciones">
        <article>
            <div>
                ...
                <a href="/E2/reservas.php?habitacion=estandar">
        ...
        <article>
            <div>
                ...
                <a href="/E2/reservas.php?habitacion=deluxe">
        ...
        <article>
            <div>
                ...
                <a href="/E2/reservas.php?habitacion=suite">
