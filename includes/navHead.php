    ...
    <ul class="top-info-menu">
        <ul>
            <?php 
                ...
                if($usuario) {
                    echo "<li>$usuario</li>";
                    echo "<li><a href='http://localhost:8888/E2/inicio.php?logout=1'>log-out</a></li>";
                } else {
                    echo "<li><a href='http://localhost:8888/E2/reservas.php?login=1'>log-in</a></li>";                  
                }
            ?>
        </ul>
    </ul>    
