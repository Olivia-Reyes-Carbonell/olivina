...
<body>
    ...
    <div class="row">
        <article class="column one excursiones">
            <div>
                <h2>Aventuras organizadas</h2>
                <img src="img/teide.jpg" class="foto">
                <img src="img/motos.jpg" class="foto">
            </div>
        </article>
        <article class="column one excursiones">
            <div>
                ...
                <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    ...
                    culpa qui officia deserunt mollit anim id est laborum. Excepteur sint occaecat cupidatat non proident, sunt in
                    culpa qui officia deserunt mollit anim id est laborum"</p>
                    <img src="img/whale.jpg" class="foto">
