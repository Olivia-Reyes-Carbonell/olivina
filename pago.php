<?php 
    ...
    if(isset($_POST["reservar"])){ 
        ...
        $url="http://localhost:8888/E2/servicios/reservar.php?id_cliente=$id_cliente&id_habitaciones=$id_habitaciones&fecha_entrada=$fecha_entrada&fecha_salida=$fecha_salida";
        ...
        if($data['mensaje'] === 'reservado'){
            ...
            session_destroy();
            header("Location: http://localhost:8888/E2/inicio.php");
        } else {
